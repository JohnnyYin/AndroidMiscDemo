...
@SupportedAnnotationTypes("com.toutiao.annotationdemo.GenerateInterface")
...
public class CreateInterfaceProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations,
        ...
        for (Element e : genElements) {
            ...
            String className = gi.value() + e.getSimpleName() + gi.suffix();
            String classString =
                    "package com.toutiao.annotationdemo.annotation.bean;\n"
            ...
            try {
                JavaFileObject jfo = filer
                        .createSourceFile("com.toutiao.annotationdemo.annotation.bean." + className, e);
